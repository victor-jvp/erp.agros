                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="razon_social"
                                        value="{{ $cliente->razon_social }}" placeholder="Razón Social" required=""
                                        name="razon_social">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="localidad"
                                        value="{{ $cliente->localidad }}" placeholder="Localidad" name="localidad">
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="direccion"
                                        value="{{ $cliente->direccion }}" placeholder="Direccion" name="direccion">
                                </div>
                            </div>
                        ...
                        <form action="/comercial/clientes/ajaxSendEmail" method="POST" id="email_form">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input type="email" class="form-control form-control-rounded" readonly name="email"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <button title="Enviar Email" data-toggle="tooltip" data-placement="top" title=""
