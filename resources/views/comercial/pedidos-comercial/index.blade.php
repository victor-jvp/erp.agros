                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <label for="variedad">Compuesto</label>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select class="form-control" id="modelo_palet" name="modelo_palet" required>
                                        ...
                                        <table class="table table_pedidos" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ (!is_null($pedido->cliente)) ? $pedido->cliente->razon_social : "" }}
                                                    </td>
                                                    <td>{{ (!is_null($pedido->destino)) ? $pedido->destino->descripcion : "" }}
                                                    </td>
                                                    <td>{{ (!is_null($pedido->formato)) ? $pedido->formato->formato : "" }}
                                                    </td>
                                                    <td>{{ (!is_null($pedido->transporte)) ? $pedido->transporte->razon_social : "" }}
                                                    </td>
                                                    <td>{{ number_format($pedido->precio, 2,",",".") }}</td>
                                                    <td>{{ number_format($pedido->kilos, 2,",",".") }}</td>
                                                    <td>{{ number_format($pedido->precio * $pedido->kilos, 2,",",".") }}
                                                    </td>
