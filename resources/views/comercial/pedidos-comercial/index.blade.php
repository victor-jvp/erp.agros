                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="anio" id="edit_anio" class="form-control" readonly>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="dia" id="edit_dia" class="form-control" readonly>
                                        </div>
                ...
                <div class="modal fade" id="modal-cantidad_palet" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" id="btnCloseModalCantidadPalet">Cerrar
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    $(document).ready(function () {
        ...
        $("#table_nuevo_pedido").on('click', '.add', function () {
            ...
            var html = '<tr id="tr_' + data_dia + '">' +
                td_rowspan +
                '<td width="20%" style="max-width: 200px"><select name="compuesto[]" class="form-control compuesto" id="compuesto_'+_rowspan+'"></select></td>' +
