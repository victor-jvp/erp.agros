    ...
    <div class="card-body">
        ...
        <form action="{{ route('usuarios.update', $usuario->id) }}" method="POST" id="form">
            ...
            <ul class="nav nav-tabs profile-nav mb-4" id="profileTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active show" id="timeline-tab" data-toggle="tab" href="#personales" role="tab"
                        aria-controls="personales" aria-selected="true">Datos Personales</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="about-tab" data-toggle="tab" href="#roles" role="tab" aria-controls="roles"
                        aria-selected="false">Asignar Roles</a>
                </li>
            </ul>

            <div class="tab-content" id="profileTabContent">
                <div class="tab-pane fade active show" id="personales" role="tabpanel" aria-labelledby="timeline-tab">
                ...
                <div class="tab-pane fade" id="roles" role="tabpanel" aria-labelledby="about-tab">
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2 table-responsive">
                            <table id="table_roles" class="table table-striped table-bordered table-sm table-condensed"
                                style="width:100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $rol->id }}</td>
                                        <td>{{ $rol->name }} <input type="hidden" name="roles[]" value="{{ $rol->name }}"></td>
                                        @php($permisos = "")
