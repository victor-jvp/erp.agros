            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="contactar-email" role="tabpanel"
                        ...
                        <form action="/almacen/proveedores/ajaxSendEmail" method="POST" id="email_form">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <button title="Enviar Email" data-toggle="tooltip" data-placement="top"
                                            ...
                                            {{ (empty($proveedor->email)) ? "disabled" : "" }}>
    ...
    $(document).ready(function () {
        ...
        $('#contactos_table .delete').on('click', function () {
            ...
            swal({
                ...
                window.location.href = "{{ url('almacen/proveedores/delete-contacto') }}" +
                    "/" + row[0]
            });
        });
    });
