        ...
        <div class="page" style="font-size: 7pt">
            ...
            <table valign="middle" class="header" style="width: 100%;">
                ...
                <tr>
                    ...
                    <td>
                        <h1><b>Nro. Orden:</b> {{ $pedido->nro_orden }}</h1>
                    </td>
                </tr>
            ...
            <table class="change_order_items" cellpadding="4">
                ...
                <tr>
                    ...
                    <td style="text-align: right">{{ round($pedido->pallet_cantidad, 2) }}</td>
                </tr>
                <tr>
                    <td>Caja</td>
                    <td>{{ $pedido->variable->caja->formato.' - '.$pedido->variable->caja->modelo }}</td>
                    <td style="text-align: right">{{ round($pedido->cajas, 2) }}</td>
                </tr>
                @foreach($pedido->tarrinas as $tarrina)
                    <tr>
                        <td>Tarrina</td>
                        <td>{{ $tarrina->tarrina->modelo }}</td>
                        <td style="text-align: right">{{ round($tarrina->cantidad * $pedido->cajas, 2) }}</td>
                    </tr>
                @endforeach
                @foreach($pedido->auxiliares as $auxiliar)
                    <tr>
                        ...
                        <td style="text-align: right">{{ round($auxiliar->cantidad * $pedido->cajas, 2) }}</td>
                    </tr>
                @endforeach
                ...
                <tbody>
                <tr>
                    <td colspan="3" style="text-align: left;"><b>Observaciones:</b> {{ $pedido->comentarios }}</td>
                </tr>
                </tbody>
            </table>
        </div>
