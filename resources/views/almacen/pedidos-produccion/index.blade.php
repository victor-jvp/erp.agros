                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <a href="javascript:void(0)" target="_blank"
                                                   class="btn btn-outline-danger btn-icon m-1"
                                                   id="btnPedidoPdf">
                    ...
                    if (json != null) {
                        ...
                        for (i = 0; i < json.data.length; i++) {
                            ...
                            table_inventario_disponible.row.add([
                                '<input type="text" class="form-control tipo" readonly name="tipo[]" value="' + row.categoria + '">',
                                descripcion,
                                '<input type="number" name="inicial[]" class="form-control inicial" value="' + row.default + '" step="0.01" placeholder="0.00" min="0.01" readonly/>',
                                '<label class="disponible">' + row.disponible + '</label>',
                                '<input type="number" class="form-control cantidad" name="cantidad[]" value="' + row.necesarios + '" step="0.01" min="0.01"/>',
                                '<input type="number" name="total[]" class="form-control total" value="' + total_salida.toFixed(2) + '" step="0.01" min="0.01" max="' + row.disponible + '"/>',
                                options
                            ]);
                        }
                ...
                success: function (json) {
                    if (json != null) {
                        ...
                        var options = '<a href="javascript:void(0);"\n' +
                            ...
                            '                                                                        </a>';
                        table_inventario_disponible.row.add([
                            '<input type="text" class="form-control tipo" readonly name="tipo[]" value="' + tipo + '">',
                            descripcion,
