                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        <div class="table-responsive table-responsive-sm">
                            <table class="table table-sm table-hover" id="table_iniciados" width="100%" data-select="0">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control chosen" id="cliente" name="cliente" required>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" id="edit_anio" class="form-control" readonly name="anio">
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <button type="button"
                                                        ...
                                                        id="btnCheckStock">
                                                        <span class="ul-btn__icon"><i class="i-Information"></i></span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <label class="radio radio-primary">
                                                <input type="radio" name="radio" class="radio_stock" value="Auxiliar"
                                                    checked>
                                                <span>Auxiliar</span>
                                        ...
                                        <div class="col-md-2">
                                            <label class="radio radio-primary">
                                                <input type="radio" name="radio" class="radio_stock" value="Tarrina">
                                                <span>Tarrina</span>
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <button type="button" class="btn btn-outline-danger"
                                            onclick="ShowMaterialesDia( {{ $cultivo->id }}, {{ $dia->id }})">Materiales</button>
                                    </div>
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            class="text-danger mr-2" data-toggle="tooltip"
                                                            data-placement="top" title="" data-original-title="Borrar">
                                                            <i class="nav-icon i-Close-Window font-weight-bold"></i>
                                                        </a>
                                                        @endif
...
<script>
    ...
    function ShowMaterialesDia(cultivo, dia) {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ route('pedidos-produccion.ajaxShowMaterialesDia') }}",
            dataType: 'JSON',
            data: {
                dia: dia,
                semana: semana,
