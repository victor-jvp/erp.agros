        ...
        <div class="col-md-12 mb-4">
            <div class="card text-left">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        @can('Trazabilidad - Proveedores | Crear')
                        <div class="col-md-3">
                    ...
                    <div class="modal fade" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                <form action="/trazabilidad/proveedores/create" method="POST" id="proveedor_form">
                                    @csrf
                                    ...
                                    @if (isset($proveedores))
                                        @foreach ($proveedores as $proveedor)
                                            <tr>
                                                ...
                                                <td>
                                                    @can('Trazabilidad - Proveedores | Modificar')
                                                    ...
                                                    @endcan
                                                    @can('Trazabilidad - Proveedores | Borrar')
        ...
        $(function () {
            ...
            $('#proveedores_table .delete').on('click', function () {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('trazabilidad/proveedores/delete') }}" + "/" + row[0]
                })
            });
