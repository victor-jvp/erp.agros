                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="variable" placeholder="Variable"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select id="euro_tarrina_modelo" class="form-control chosen"
                                                data-placeholder="Seleccione...">
                                                <option value=""></option>
                                                @if (isset($tarrinas))
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="euro_tarrina_cantidad"
                                                placeholder="Cantidad" step="0.01">
                                        </div>
                                        <div class="col-md-2 mb-3">
                                            <br>
                                            <button id="btnAddEuroTarrina" type="button"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select id="grand_auxiliar_modelo" class="form-control chosen"
                                                data-placeholder="Seleccione...">
                                                <option value=""></option>
                                                @if (isset($auxiliares))
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="grand_auxiliar_cantidad"
                                                placeholder="Cantidad" step="0.01">
                                        </div>
                                        <div class="col-md-2 mb-3">
                                            <br>
                                            <button id="btnAddGrandAuxiliar" type="button" data-index=""
                                                class="btn btn-success btn-icon">
                                                <i class="i-Add"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade active show" id="EuroPallet" role="tabpanel"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="euro_cantoneras"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                id="euro_cubre_cantidad" placeholder="Cantidad Cubres"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                id="euro_auxiliar_cantidad" placeholder="Cantidad"
                                                                step="0.01">
                                                        </div>
                                                        <div class="col-md-2 mb-3">
                                                            <br>
                                                            <button id="btnAddEuroAuxiliar" type="button" data-index=""
                                                                class="btn btn-success btn-icon">
                                                                <i class="i-Add"></i>
                                                            </button>
                                                        </div>
                                                ...
                                                <div class="tab-pane fade" id="PalletGrande" role="tabpanel"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 mb-3">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                id="grand_cantidad" placeholder="Cantidad de cajas"
                                                                name="grand_cantidad">
                                                        </div>
                                                        <div class="col-md-4 mb-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            <label for="grand_cubre_cantidad">Cantidad
                                                                Cubres</label>
                                                            <input type="number" class="form-control"
                                                                id="grand_cubre_cantidad" placeholder="Cantidad Cubres"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            <label for="grand_auxiliar_cantidad">Cantidad</label>
                                                            <input type="number" class="form-control"
                                                                id="grand_auxiliar_cantidad" placeholder="Cantidad"
                                                                step="0.01">
                                                        </div>
                                                        <div class="col-md-2 mb-3">
                                                            <br>
