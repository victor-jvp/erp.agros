        ...
        <div class="card text-left">
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active show" id="cultivos-tab" data-toggle="tab" href="#cultivos" role="tab"
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade active show" id="cultivos" role="tabpanel" aria-labelledby="cultivos-tab">
