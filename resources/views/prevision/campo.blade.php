...
@section('bottom-js')
    ...
    <script>
        ...
        function EditPedido(id) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('pedidos-campo.GetPedido') }}",
                dataType: 'JSON',
                data: {
                    id: id
                },
                success: function (data) {
                    ...
                    LoadParcelaByFinca(data.parcela.finca_id, data.parcela_id);
                    ...
                    $('#pedido_form').attr('action', '/pedidos-campo/' + data.id);

                    $("#modal-pedido-title").html("Modificar Entrada");
        ...
        function DeletePedido(id) {
            swal({
                ...
                window.location.href = "{{ url('pedidos-campo/delete') }}" + "/" + id
            })
        }
