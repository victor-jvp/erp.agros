                                                                        ...
                                                                        <table class="table table-bordered">
                                                                            ...
                                                                            @foreach($dia->previsiones as $prevision)
                                                                                @if($prevision->finca_id == $finca->id)
                                                                                    <tr>
                                                                                        <td>{{ $prevision->trazabilidad->parcela->parcela }}
                                                                                        </td>
                                                                                        <td>{{ $prevision->trazabilidad->variedad->cultivo->cultivo }}
                                                                                        </td>
                                                                        ...
                                                                        @php
                                                                            ...
                                                                            foreach ($comentarios as $comentario) {
                                                                              if ($comentario->finca_id == $finca->id && $comentario->cultivo_id == $cultivo->id) {
                                                                                $seccionComentario = '<input type="hidden" name="comentario_id" id="comentario_id"
                                                                                value="'. $comentario->id .'">
                                                                                <textarea class="form-control" name="comentario" id="comentario" cols="" rows="2"
                                                                                  placeholder="Comentarios...">'. $comentario->comentario .'</textarea>';
                                                                              }
                                                                            }
                                                                            if($seccionComentario == ""){
                                                                              echo '<input type="hidden" name="comentario_id" id="comentario_id" value="">
                                                                              <textarea class="form-control" name="comentario" id="comentario" cols="" rows="2"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="5">
                                                                    @if (count($dia->previsiones) > 0)
                                                                        ...
                                                                        &&
                                                                        $dia->previsiones{0}->trazabilidad->parcela->finca_id ==
                                                                        $finca->id)
                                                                            <table class="table table-bordered">
                                                                                <tbody>
                                                                                @foreach($dia->previsiones as $prevision)
                                                                                    <tr>
                                                                                        @if($prevision->trazabilidad->parcela->finca_id
                                                                                        == $finca->id)
                                                                                            <td>{{ $prevision->trazabilidad->parcela->parcela }}
                                                                                            </td>
                                                                                            <td>{{ $prevision->trazabilidad->variedad->cultivo->cultivo }}
