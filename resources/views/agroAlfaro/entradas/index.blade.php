                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="date" class="form-control" id="m_salida_fecha" placeholder="Fecha"
                                                       required="" name="fecha">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="producto_id" id="m_salida_producto" class="form-control chosen"
                                                        required>
                                                    <option value=""></option>
                                                    @foreach ($compuestos as $compuesto)
                                                        <option value="{{ $compuesto->id }}">
            ...
            table_salidas = $('#salidas_table').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        data: null,
                        render: function (data, type, row) {
                            var editar = '@can("AgroAlfaro - Entradas | Modificar") <a href="javascript:void(0);" onclick="modalEditSalida(this)" class="text-success mr-2 edit" data-toggle="tooltip" data-placement="top" data-original-title="Editar"><i class="nav-icon i-Pen-2 font-weight-bold "></i></a>@endcan';
                            var borrar = '@can("AgroAlfaro - Entradas | Borrar") <a href="javascript:void(0);" onclick="modalDeleteSalida(this)" class="text-danger mr-2 delete" data-toggle="tooltip" data-placement="top" title="" data-original-title="Borrar"><i class="nav-icon i-Close-Window font-weight-bold "></i></a>@endcan';
