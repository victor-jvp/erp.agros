                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="salida_precio"
                                                        required placeholder="Precio Venta" name="precio" step="0.01">
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="m_salida_precio_liquidacion"
                                                placeholder="Precio Liquidación" name="precio_liquidacion" readonly
                                                step="0.01">
                                        </div>
                                        <div class="col-md-6 mb-3 mt-4">
                                            <label class="checkbox checkbox-primary">
    ...
    $(function () {
        ...
        $("#btnGenerarMerma").click(function (e) {
            swal({
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ url('agroAlfaro/entradas/ajaxGenerarMerma') }}",
                    dataType: 'JSON',
                    data: {
                        id: entrada_id
                    },
